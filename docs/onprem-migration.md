...
The whole point of the ports-and-adapters shape is that Mkt5's exit story is **demonstrable,
...
To run Mkt5 on a sovereign / on-premise platform, implement these adapter bodies (the only
files that change):
