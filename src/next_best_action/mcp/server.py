"""Serve the governed tool catalog next-best-action already declares, over MCP 2026-07-28.
...
def build_server(actor: str, *, with_audit_tools: bool = True) -> Any:
    """Build the MCP server for next-best-action's catalog, refusing on any catalog/handler
    mismatch.
    """
