...
In D5 the LLM only explains "why recommended" over the already-computed deterministic ranking (the
eligibility, the consent decision and the score). It never decides the numbers. The
