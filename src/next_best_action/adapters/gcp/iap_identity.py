...
class IapIdentityAdapter:
    ...
    def __init__(self, settings: Settings) -> None:
        ...
        # "/projects/<NUM>/apps/<ID>". Configure via MKT_NBA_IAP_AUDIENCE; required in secure mode.
        ...
        self._audience = read_env_setting("MKT_NBA_IAP_AUDIENCE").value
    ...
    def resolve(self, ctx: RequestContext) -> Principal:
        ...
        if not self._audience:
            raise IapAudienceUnconfiguredError(
                "MKT_NBA_IAP_AUDIENCE is not configured, so no IAP assertion can be verified "
