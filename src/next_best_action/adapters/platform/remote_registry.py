...
Routes agent registration / discovery to the shared **A3 Agent Registry**. Constructs
cleanly with no Google Cloud SDK; the HTTP body is wired in the platform phase.
"""
...
_PHASE = "RemoteRegistryAdapter calls are wired in the platform phase."
