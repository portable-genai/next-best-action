...
def build_spec() -> PluginSpec:
    ...
    from next_best_action.adapters.gcp.mcp_tool_catalog import McpToolCatalogAdapter
    from next_best_action.agent.agent_card import agent_card_document
    ...
    return PluginSpec(
        ...
        license="Apache-2.0",
        repository="https://github.com/portable-genai/next-best-action",
        ...
        servers={
            "next-best-action": StdioServer(
                command="python",
                args=("-m", "next_best_action.mcp"),
                cwd="${PLUGIN_ROOT}",
            )
        },
